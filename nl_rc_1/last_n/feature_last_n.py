...
class nlfea:
    def __init__(self,b=0.5,n=10,test_len=10,reg=1e-8,start = 0.2,eps = 0.1):
        self.b = b
        self.n = n
...
def logistic_data(a = 3.95, i = 0.5422,length = 1500):
    x = np.zeros(length)
    x[0] = i
...
model = nlfea(n=10,test_len=test_len,b=5)
